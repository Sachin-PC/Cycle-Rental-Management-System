...
<head>
  ...
  function go_home()
		{
			var myvar = 1;
			window.location.replace("home?id="+myvar+"&location="+1);
		}
</script>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<div class="contact-form">
	        <img src="images/cyc_ic11.jpg" class="avatar">
	        <h2>Select your Ride</h2>
	        <form method="POST" action="selectcycle">
